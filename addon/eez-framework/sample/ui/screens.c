...
static void event_handler_cb_heating_screen_temperature_arc(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            assignIntegerProperty(flowState, 9, 2, value, "Failed to assign Value in Arc widget");
        }
    }
}
...
static void event_handler_cb_heating_screen_power_arc(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        int32_t value = lv_arc_get_value(ta);
        if (tick_value_change_obj != ta) {
            assignIntegerProperty(flowState, 17, 2, value, "Failed to assign Value in Arc widget");
        }
    }
}
...
static void event_handler_cb_lighting_screen_obj23(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            assignIntegerProperty(flowState, 14, 2, value, "Failed to assign Value in Slider widget");
        }
    }
}
...
static void event_handler_cb_lighting_screen_save_1(lv_event_t *e) {
    ...
    void *flowState = e->user_data;
    if (event == LV_EVENT_CLICKED) {
        flowPropagateValue(flowState, 24, 1);
    }
}
...
void create_screen_heating_screen() {
    ...
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    {
        ...
        }
        {
            ...
            create_user_widget_header(obj, getFlowState(flowState, 2), 26);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            // heating_button_1
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_zone_selector(obj, getFlowState(flowState, 23), 93);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            // account_box_1
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_account_box(obj, getFlowState(flowState, 24), 5);
...
void tick_screen_heating_screen() {
    void *flowState = getFlowState(0, 0);
    tick_user_widget_header(getFlowState(flowState, 2), 26);
    {
        int32_t new_val = evalIntegerProperty(flowState, 9, 2, "Failed to evaluate Value in Arc widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 17, 2, "Failed to evaluate Value in Arc widget");
    ...
    tick_user_widget_zone_selector(getFlowState(flowState, 23), 93);
    tick_user_widget_account_box(getFlowState(flowState, 24), 5);
}
...
void create_screen_security_screen() {
    ...
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    {
        ...
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            lv_obj_set_pos(obj, -12, -262160);
            lv_obj_set_size(obj, 824, 629);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
...
void tick_screen_security_screen() {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 19, 2, "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 21, 2, "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 25, 2, "Failed to evaluate Disabled state");
...
void create_screen_lighting_screen() {
    ...
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    {
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_header(obj, getFlowState(flowState, 2), 36);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            // heating_button_3
        ...
        }
        {
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_zone_selector(obj, getFlowState(flowState, 26), 101);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            // account_box_3
            ...
            lv_obj_set_local_style_prop(obj, LV_STYLE_BG_OPA, value, LV_PART_MAIN);
            lv_obj_set_local_style_prop(obj, LV_STYLE_BORDER_WIDTH, value, LV_PART_MAIN);
            create_user_widget_account_box(obj, getFlowState(flowState, 27), 17);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
        {
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.obj34 = obj;
            lv_obj_set_pos(obj, 690, 544);
            lv_obj_set_size(obj, 100, 50);
            lv_obj_add_event_cb(obj, event_handler_cb_lighting_screen_obj34, LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff7b829b), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_grad_color(obj, lv_color_hex(0xff4f64ce), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void tick_screen_lighting_screen() {
    void *flowState = getFlowState(0, 2);
    tick_user_widget_header(getFlowState(flowState, 2), 36);
    {
        const char *new_val = evalTextProperty(flowState, 12, 2, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 14, 2, "Failed to evaluate Value in Slider widget");
    ...
    tick_user_widget_zone_selector(getFlowState(flowState, 26), 101);
    tick_user_widget_account_box(getFlowState(flowState, 27), 17);
}
...
void create_screen_thank_you_screen() {
    ...
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_thank_you_bitmap);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_ADV_HITTEST);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
        }
    }
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_label_set_text(obj, "Conference room");
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
